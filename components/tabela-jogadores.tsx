 ...
 *
 * A página `/ranking` monta duas tabelas com este mesmo componente — uma
 * só do Dominantes (`mostrarElementos`, sem `mostrarServidor`: é um mundo
 * só ali dentro) e outra com PVE Free + PVE VIP juntos (`mostrarServidor`,
 * sem elementos: aqueles mundos não têm registro de raça). A página
 * `/ranking/dominantes` usa a mesma combinação da primeira.
 */
...
export function TabelaJogadores({
  ...
  /** A coluna Servidor — só faz sentido quando a tabela mistura mundos. */
  mostrarServidor?: boolean;
  /** Raça e elemento — só o Dominantes preenche, é exigência do fórum de lá. */
