              ...
              {template.Passives.map((p) => {
                ...
                return (
                  <li
                    ...
                    className={`fundo-losango flex items-center justify-between gap-2 overflow-hidden rounded-[var(--radius-control)] border bg-surface px-3 py-1.5 text-sm ${rank === 5 ? "brilho-lendario" : ""}`}
