...
- **Filtro por servidor no ranking geral.** Clicando em **Servidor** no cabeçalho dá para ver um mundo de cada vez. O ranking ordena por level, e como os PVE têm dois anos de vantagem, as primeiras linhas eram todas level 80 e ninguém do Dominantes aparecia — agora o mundo novo tem o próprio pódio. A tabela também passou a trazer bem mais jogadores, para o filtro ter de onde tirar.
